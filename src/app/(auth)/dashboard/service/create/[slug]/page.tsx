...
export default function ServiceDashboardEditPage({
  params,
}: {
  params: { slug: string };
}) {
        ...
        <div className="flex items-center gap-2 px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator className="hidden md:block" />
              <BreadcrumbItem>
                <BreadcrumbPage>Modifier le service</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
            <div className="flex items-center justify-between gap-6">
              <div className="w-1/2">
                ...
                <Input id="name" {...register("name")} value={service?.name} />
                {errors.name && (
              ...
              <div className="w-1/2">
                ...
                <Input id="code" {...register("code")} value={service?.code} />
                {errors.code && (
            ...
            <div className="flex items-center justify-between gap-6">
              <div className="w-1/2">
                ...
                <Select onValueChange={(value) => setValue("category", value)} value={service?.category}>
              ...
              <div className="w-1/2">
                ...
                <Select onValueChange={(value) => handleUnitChange(value)} value={service?.unit}>
                  <SelectTrigger className="w-full">
            ...
            <div className="flex items-center justify-between gap-6">
              ...
              <div className="w-1/2">
                ...
                <Input id="quantity" type="number" {...register("quantity")} value={service?.quantity} />
                {errors.quantity && (
                  <p className="text-sm text-red-500">
            ...
            <div className="flex items-end justify-between gap-4">
              ...
              <div className="w-2/3">
                ...
                <Select
                  onValueChange={(value) => setValue("localisation", value)} value={service?.localisation}
                >
                  <SelectTrigger>
