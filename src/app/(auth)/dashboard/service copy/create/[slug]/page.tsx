        ...
        <div className="flex items-center gap-2 px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator className="hidden md:block" />
              <BreadcrumbItem>
                <BreadcrumbPage>Modifier le produit</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
      ...
      <div className="flex min-h-screen justify-center bg-[#F7F9F4] py-4">
        <div className="w-full px-6">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
            ...
            <input type="hidden" value="PRODUCT" {...register("type")} />

            <div>
              <Label htmlFor="isPerishable">Est un produit périsable ?</Label>
              <Checkbox
                checked={service?.isPerishable}
                id="isPerishable"
            ...
            <div>
              ...
              <Checkbox
                checked={service?.isDerivedProduct}
                id="isDerivedProduct"
